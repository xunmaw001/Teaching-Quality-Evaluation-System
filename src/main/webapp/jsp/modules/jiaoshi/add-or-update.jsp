...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>教师邮箱</label>
										<input id="jiaoshiyouxiang" name="jiaoshiyouxiang" class="form-control" placeholder="教师邮箱">
									</div>
	...
	<script>
		...
		function dataBind(){
			...
			$("#jiaoshiyouxiang").val(ruleForm.jiaoshiyouxiang);	
		}		
		//图片显示
		function showImg(){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.jiaoshiyouxiang != null && res.data.jiaoshiyouxiang != ''){

					$("#jiaoshiyouxiang").val(res.data.jiaoshiyouxiang);
					}
				}
			});  
            }
