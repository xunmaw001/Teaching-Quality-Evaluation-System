	...
	<div class="container">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input type="text" name="jiaoshixingming" placeholder="教师姓名" class="form-control-i">
							</div>
																																														<div class="form-group">
							...
							<input type="text" name="lianxidianhua" placeholder="联系电话" class="form-control-i">
																								...
																								<div class="form-group">
							<label class="label">教师邮箱</label> 
							<input type="text" name="jiaoshiyouxiang" placeholder="教师邮箱" class="form-control-i">
							</div>
