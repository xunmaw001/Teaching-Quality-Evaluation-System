		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑督导评教</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>督导评教管理</span></li>
								<li class="breadcrumb-item active"><span>编辑督导评教</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">督导评教信息</h3>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<select id="pingfenSelect" name="pingfen" class="form-control">
												...
												<option class="pingfenOption" value="6">
													6
												</option>
												<option class="pingfenOption" value="7">
													7
												</option>
												<option class="pingfenOption" value="8">
													8
												</option>
												<option class="pingfenOption" value="9">
													9
												</option>
												<option class="pingfenOption" value="10">
													10
												</option>
										</select>	
									</div>	
									...
									<div class="form-group col-md-6">
										<label>督导账号</label>
										<input id="dudaozhanghao" name="dudaozhanghao" class="form-control" placeholder="督导账号">
									</div>
									<div class="form-group col-md-6">
										<label>督导姓名</label>
										<input id="dudaoxingming" name="dudaoxingming" class="form-control" placeholder="督导姓名">
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "dudaopingjiao/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("dudaopingjiao/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("dudaopingjiao/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("dudaopingjiao"+colName,"GET",{
			...
			function fill(){
				...
				http(accountTableName+'/session','GET',{},(res)=>{
					if(res.code == 0){
						...
						if(res.data !=null && res.data.dudaozhanghao != null && res.data.dudaozhanghao != ''){
							$('#dudaozhanghao').val(res.data.dudaozhanghao)
						}
						if(res.data !=null && res.data.dudaoxingming != null && res.data.dudaoxingming != ''){
							$('#dudaoxingming').val(res.data.dudaoxingming)
						}
						$(validform());
					}
				});
		...
		function dataBind(){
			...
			$("#dudaozhanghao").val(ruleForm.dudaozhanghao);	
			$("#dudaoxingming").val(ruleForm.dudaoxingming);	
		}		
		//图片显示
		function showImg(){
		}		
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.dudaozhanghao != null && res.data.dudaozhanghao != ''){

					$("#dudaozhanghao").val(res.data.dudaozhanghao);
					}
					if(res.data != null && res.data != '' && res.data.dudaoxingming != null && res.data.dudaoxingming != ''){
