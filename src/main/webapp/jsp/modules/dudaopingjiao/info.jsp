						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="dudaozhanghao" name="dudaozhanghao" class="form-control" v-model="ruleForm.dudaozhanghao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>督导姓名</label>

									<input id="dudaoxingming" name="dudaoxingming" class="form-control" v-model="ruleForm.dudaoxingming" readonly>
									</div>
