...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">督导评教统计</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>督导评教统计</span></li>
							</ol>
						</div>
					</div>
				</div>
	...
	function draw(){
		...
		var myChart = echarts.init(document.getElementById('main'),'macarons');
				...
				myChart.setOption({
			title: {text : '督导评教',left: 'center',top: 20},
			tooltip: {
				trigger: 'item',
	...
	$.ajax({ 
		type: "GET",
		url: baseUrl+"value/dudaopingjiao/"+xColumnName+'/'+yColumnName,
		data:{ },
	...
	function group(colName){
		$.ajax({ 
			type: "GET",
			url: baseUrl+"group/dudaopingjiao/"+colName,
			data:{	tableName: "dudaopingjiao",
					columnName: colName
					},
			beforeSend: function(xhr) {
				xhr.setRequestHeader("token", window.sessionStorage.getItem('token'));
