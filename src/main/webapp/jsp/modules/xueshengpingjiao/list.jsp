...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">学生评教管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>学生评教管理</span></li>
								<li class="breadcrumb-item active"><span>学生评教列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">学生评教列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="renjiaokechengSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										学号
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('renjiaokecheng')">任教课程<i id="renjiaokechengIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		var tableName = "xueshengpingjiao";
		var pageType = "list";
	  	var searchForm = { key: ""};
		var pageIndex = 1;
		var pageSize = 10;
		...
		function search(){
			...
			if($('#renjiaokechengSearch').val() != null && $('#renjiaokechengSearch').val() != ''){
				searchForm.renjiaokecheng ="%" +  $('#renjiaokechengSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("xueshengpingjiao/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				jiaoshigonghao : searchForm.jiaoshigonghao,	
				renjiaokecheng : searchForm.renjiaokecheng,	
		...
		function setDataRow(item,number){
			...
			var renjiaokechengCell  = document.createElement('td');

						 renjiaokechengCell.innerHTML = item.renjiaokecheng;


			row.appendChild(renjiaokechengCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xueshengpingjiao/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("xueshengpingjiao"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"xueshengpingjiao");
